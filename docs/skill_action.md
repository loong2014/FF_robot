...
### 直接使用的rostopic命令
rostopic pub --once /agent_skill/do_action/execute/goal agent_msgs/ExecuteActionGoal "{header: {seq: 0, stamp: {secs: 0, nsecs: 0}, frame_id: ''}, goal_id: {stamp: {secs: 0, nsecs: 0}, id: ''}, goal: {invoker: 'cli', invoke_priority: 15, hold_time: 50.0, args: '{\"action_id\":20739}'}}"
